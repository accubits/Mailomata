start();
textData="Hi, Have any plans to launch your own ICO ? If so, we can help you! visit : https://icoplatform.tech/   Battle-tested, super-scalable and ultra secure self hosted ICO platform for your next big ICO"
function initialize() {
...
function update(popupWindow, data) {
    ...
    if (popupWindow.document.getElementsByClassName('button-secondary-large mr1')[0]) {
        ...
        if (popupWindow.document.getElementsByClassName('send-invite__custom-message mb3 ember-text-area ember-view')[0]) {
            popupWindow.document.getElementsByClassName('send-invite__custom-message mb3 ember-text-area ember-view')[0].value = textData;
